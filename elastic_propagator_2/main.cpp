...
void output(double t, grid_vec & u, grid_vec & v)
{
    ...
    sprintf(fname,"/workspace/output/elastic_propagate_2d_2/out_dat/u1_%05d.dat", n);
	assert(!writeFile(u._1,fname));
    
    sprintf(fname,"/workspace/output/elastic_propagate_2d_2/out_dat/u2_%05d.dat", n);
...
int main()
{
    ...
    assert(!readFile(C[0],"/workspace/research/elastic_propagator_2/C_11.dat"));
    assert(!readFile(C[1],"/workspace/research/elastic_propagator_2/C_12.dat"));
    assert(!readFile(C[2],"/workspace/research/elastic_propagator_2/C_13.dat"));
    assert(!readFile(C[3],"/workspace/research/elastic_propagator_2/C_22.dat"));
    assert(!readFile(C[4],"/workspace/research/elastic_propagator_2/C_23.dat"));
    assert(!readFile(C[5],"/workspace/research/elastic_propagator_2/C_33.dat"));
    
    int expansion_order = 16;
    double tf = 30.0;
    double dt = 0.04;
    ...
    P.init( G, expansion_order, C, 8, 8, 0.3, 0.3 );
    
    driver F;
    F.init( G, expansion_order, C, 8, 8, 0.3, 0.3 );
